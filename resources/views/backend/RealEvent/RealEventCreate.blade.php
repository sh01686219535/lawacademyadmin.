                                      ...
                                      <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea name="description" id="basic-default-name" class="form-control" placeholder="Enter Course Description" ></textarea>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label class="form-label" for="basic-default-name">Cost</label>
                                                <input type="text" class="form-control" name="cost" id="basic-default-name" placeholder="Enter Course Cost" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="basic-default-name">Start Date</label>
                                                <input type="datetime-local" class="form-control" name="start_date" id="basic-default-name" placeholder="Enter Start Date" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="basic-default-name">End Date</label>
                                                <input type="datetime-local" class="form-control" name="end_date" id="basic-default-name" placeholder="Enter Start Date" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="basic-default-name">Venue</label>
                                                <input type="text" class="form-control" name="venue" id="basic-default-name" placeholder="Enter End Date" />
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="video" id="basic-default-name" placeholder="Enter Video's link" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                           </div>
