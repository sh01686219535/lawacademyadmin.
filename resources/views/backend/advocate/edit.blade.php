        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <h5 class="card-title text-primary" style="text-transform: uppercase">Advocate Update</h5>
                                       ...
                                       @csrf
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" value="{{$advocate->name}}" name="name" id="name" placeholder="Enter Name" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label my-2" for="phone">Phone</label>
                                                <input type="text" class="form-control"value="{{$advocate->phone}}" name="phone" id="phone" placeholder="Enter phone" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label my-2" for="work_place">Work Place</label>
                                                <input type="text" class="form-control" value="{{$advocate->work_place}}" name="work_place" id="work_place" placeholder="Enter Work Place" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label my-2" for="image">Image</label>
                                                <input type="file" class="form-control" name="image" id="image"/>
                                              @if($advocate->image)
                                              <img height="100px" width="100px" src="{{asset($advocate->image) }}" alt="">
                                              @else
