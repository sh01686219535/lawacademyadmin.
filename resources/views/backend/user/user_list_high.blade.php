                            ...
                            <tbody> @foreach($user as $users)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('user_lower_print',$users->id) }}" title="Edit" class="btn btn-info" id="Edit"><i class="fa-solid fa-print"></i>
                                        </a>
                                    </td>
                                    <td>
                                    <a href="{{ route('user_payment',$users->id) }}" title="Edit" class="btn btn-primary" id="Edit"><i class="fa-solid fa-bangladeshi-taka-sign"></i></a>
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
