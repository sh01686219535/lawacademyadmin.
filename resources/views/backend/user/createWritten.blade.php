        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-12">
                        <div class="card-body">
                            <h5 class="card-title text-primary" style="text-transform: uppercase"><strong>Written </strong> Exam Preparation</h5>
                            <div class="row">
                                <!-- Basic Layout -->
                                <div class="col-xxl">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    {{-- <div class="col-md-3">
                                                        <label class="form-label my-2" for="qualification">Qualificaton</label>
                                                        <select class="form-control" name="qualification" id="qualification">
                                                            <option value="">Select Qualification</option>
                                                            <option value="llb_completed">LLB Completed</option>
                                                            <option value="llm_completed">LLB&LLM Completed</option>
