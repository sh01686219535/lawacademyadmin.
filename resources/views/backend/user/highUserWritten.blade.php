                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-3 d-none">
                                                        <label class="form-label my-2" for="basic-default-name">High Court</label>
                                                        @foreach ($highCourt as $lows)
                                                        <select class="form-control" name="high_court" id="basic-default-name">
