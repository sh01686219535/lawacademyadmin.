<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ $data['active_menu']  == 'batch_panel'  ? 'active open' : '' }}">
      ...
      <ul class="menu-sub {{ $data['active_menu'] == 'batch_wise_student' ? 'active' : '' }}">
        <li class="menu-item ">
          <a href="{{ route('batch_wise_student') }}" class="menu-link">
            <div data-i18n="Without menu">Batch Wise Student</div>
          </a>
        </li>
      </ul>
    </li>
