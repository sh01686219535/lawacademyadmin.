                ...
                <div class="card-head m-2" style="display: flex;justify-content: space-between;">
                 ...
                 <div class="card-body">
                    <table class="table table-hover table-borderd" id="example">
                        ...
                        <tbody>
                            @php $i = 1 @endphp @foreach( $data['lower'] as $lower)
                            <tr>
                                <td>{{$i++}}</td>

                                <td>{{$lower->court_name}}</td>
                                <td>
                                    <a href="{{ route('event_edit',$lower->id) }}" title="Edit" class="btn btn-primary" id="Edit"><i class="fa-solid fa-eye"></i>
                                    </a>
                                    <a href="{{ route('event_delete',$lower->id) }}" title="Delete" class="btn btn-danger" id="delete" onclick="return confirm('Are You Sure!!')"><i class="fa-solid fa-trash"></i>
                                    </a>
                                </td>
