                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="course_id" id="course_title" class="form-control ">
                                                            ...
                                                            <option value="{{ $item->id }}" {{ $item->id == $user->course_id ? 'selected' : ''  }}>{{ $item->title }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 mt-3">
                                                        ...
                                                        <select name="batch_id" id="batch_id" class="form-control ">
                                                            ...
                                                            <option value="{{ $item->id }}" {{ $item->id == $user->batch_id ? 'selected' : '' }}>{{ $item->batch_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 mt-3">
                                                        ...
                                                        <input type="text" name="admissionCost" id="admissionCost" class="form-control">
                                                    </div>
                                                    <div class="col-md-6 mt-3">
